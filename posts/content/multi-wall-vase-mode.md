...
4. Now select the cut we just made as the feature and the line we drew as the Axis. You will have to turn on `Reapply features` if this errors for you initially.
5. Lastly for this, adjust your `Instance count` until you're happy with the number of ribs that will be added. Each cut will become a rib.
